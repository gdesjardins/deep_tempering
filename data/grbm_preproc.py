...
class GRBMPreprocessor(object):
    ...
    def load_params(self):
        ...
        self.Wv = params['vishid_all']
        self.hbias = params['hidbiases_all'][0]
        self.vbias = params['visbiases'][0]
        ...
        self.zz = numpy.hstack(
                (means['zz1'] * numpy.ones(self.n_v/2),
                 means['zz2'] * numpy.ones(self.n_v/2)))
    ...
    def preproc(self, xval):
        return self.h_given_x_func(xval)
